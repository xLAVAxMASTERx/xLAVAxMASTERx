...
const projects = [
  {
    title: "RECON",
    cardImage: "assets/images/project-page/RN07.jpeg",
    description: "An Octa Raspberry Pi ARM Cluster",
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "http://recon.mu-enigma.org/",
    Githublink: "https://github.com/MU-Enigma/RECON-setup",
  },
  {
  ...
  {
    title: "Decoding Multiple Layers of Encoding with GPT",
    cardImage: "",
    description: "Decoding random seuqences of multi layer encoded text using Combinational Neural Network Structure and GPT",
    tagimg: "https://miro.medium.com/max/2800/0*U2DmhXYumRyXH6X1.png",
    Previewlink: "",
    Githublink: "",
  },
  {
    title: "Automated Invoice System analysis",
    cardImage: "assets/images/project-page/invoice.png",
    description: "Automatic invoice system which extracts items,quantity,price from the invoice and gives data analysis on it , has database system managing all previous analysis and bill available for download",
    tagimg:
  ...
  },
  {
    ...
    cardImage: "assets/images/project-page/legal.png",
    description: "A full software that calculates the total risk associated with the titles selected by the user and highlights risky regions of the document while creating an analysis of it.",
